                        ...
                        <div class="col-md-6 col-lg-7 d-flex align-items-center">
                            <div class="card-body p-4 p-lg-5 text-black">
                                <form action="/user?action=login" method="post">
                                    ...
                                    <h5 style="color: red">${messSingUp}</h5>
                                    <h5 style="color: aqua">${messSingOk}</h5>
                                    ...
                                    <p class="mb-5 pb-lg-2" style="color: #393f81;">Don't have an account? <a href="/singup.jsp" style="color: #393f81;">Register here</a></p>
